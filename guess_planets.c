...
int main(){
char ccolors[9][30]={"mercury","venus","earth","mars","jupiter","saturn","uranus","neptune","pluto"};
char tcolor[30];
char ttcolor[30];
char s[8024];
char *ssss=&tcolor[0];
...
strings(sss,nn,'*');
system("clear");
printf("game gess a planet\n");
do{
printf("gess a planet %s abcdefghijklmnopqrstuvwxyz  enter to give up\n",ttcolor);
ss=gets(ss);
b=s[0];
ll[c]=(int) b;
c++;
